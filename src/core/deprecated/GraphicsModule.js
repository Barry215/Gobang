...
(function (GraphicsModule) {
    ...
    class GraphicsCanvasImpl {
        ...
        getMouseLocation(e) {
            ...
            let x = e.clientX;
            let y = e.clientY;
            return new Coordinate((x - box.left) * (this.canvas.width / box.width), (y - box.top) * (this.canvas.height / box.height));
        }
        /**
         ...
         */
        clearGraphics() {
            this.content2D.clearRect(0, 0, Number(this.canvas.getAttribute('width')), Number(this.canvas.getAttribute('height')));
        }
        /**
         * @method drawCircle
         * @description 画一个圆形
    ...
    GraphicsModule.GraphicsCanvasImpl = GraphicsCanvasImpl;
})(GraphicsModule || (GraphicsModule = {}));
//# sourceMappingURL=GraphicsModule.js.map